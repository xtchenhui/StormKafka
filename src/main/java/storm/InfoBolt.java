...
public class InfoBolt extends BaseRichBolt {
	...
	public static final Pattern EMOTICON_REGEX_PATTERN = Pattern
			.compile("(?<=^|" + EMOTICON_DELIMITER + ")(" + SMILEY_REGEX_PATTERN.pattern() + "|"
					+ FROWNY_REGEX_PATTERN.pattern() + ")+(?=$|" + EMOTICON_DELIMITER + ")");
	...
	ArrayList<String> happy = new ArrayList<String>(Arrays.asList("1f601", "1f602", "1f603", "1f604", "1f605", "1f606",
			"1f609", "1f60A", "1f60B", "1f60D", "1f618", "1f61A", "1f61C", "1f61D", "1f624", "1f632", "1f638", "1f639",
			"1f63A", "1f63B", "1f63D", "1f647", "1f64B", "1f64C", "1f64F", "U+270C", "U+2728", "U+2764", "U+263A",
			"U+2665", "U+3297", "1f31F", "1f44F", "1f48B", "1f48F", "1f491", "1f492", "1f493", "1f495", "1f496",
			"1f497", "1f498", "1f499", "1f49A", "1f49B", "1f49C", "1f49D", "1f49D", "1f49F", "1f4AA", "1f600", "1f607",
			"1f608", "1f60E", "1f617", "1f619", "1f61B", "1f31E"));

	ArrayList<String> mediumHappy = new ArrayList<String>(
			Arrays.asList("1f60C", "1f60F", "1f633", "1f63C", "1f646", "U+2B50", "1f44D", "1f44C"));

	ArrayList<String> neutral = new ArrayList<String>(
			Arrays.asList("1f614", "1f623", "U+2753", "U+2754", "1f610", "1f611", "1f62E", "1f636"));

	ArrayList<String> mediumUnhappy = new ArrayList<String>(
			Arrays.asList("1f612", "1f613", "1f616", "1f61E", "1f625", "1f628", "1f62A", "1f62B", "1f637", "1f635",
					"1f63E", "U+26A0", "1f44E", "1f4A4", "1f615", "1f61F", "1f62F", "1f634"));

	ArrayList<String> unhappy = new ArrayList<String>(
			Arrays.asList("1f620", "1f621", "1f622", "1f629", "1f62D", "1f630", "1f631", "1f63F", "1f640", "1f645",
					"1f64D", "1f64E", "U+274C", "U+274E", "1f494", "1f626", "1f627", "1f62C"));
	...
	public void execute(Tuple tuple) {
		try {
			...
			/*
			 * emoticonAndScore = getScoreIfEmoticonPresent(originalTweet); int
			 * matchedEmoticonScore =
			 * Integer.parseInt(emoticonAndScore.get("score")); String
			 * matchedEmoticon = emoticonAndScore.get("emoticon");
			 * 
			 * System.out.println("Emotion: " + matchedEmoticon + " Score: " +
			 * emoticonAndScore.get("score"));
			 * 
			 * 
			 * collector.emit(new
			 * Values(originalTweet,word,noun,verb,object,county_id,url,
			 * matchedEmoticonScore, matchedEmoticon, sentiment));
			 */
	...
	public void declareOutputFields(OutputFieldsDeclarer outputFieldsDeclarer) {
		...
		outputFieldsDeclarer.declare(new Fields("original-tweet", "tweet-word", "noun", "verb", "object", "county_id",
				"url", "matchedEmoticonScore", "matchedEmoticon", "sentiment"));
	}
}
